    ...
    context "after login, " do
      ...
      describe "balance adjustment" do
        context "action_year/month/day is set," do
          specify {
            expect { xhr :post, :create, :action_year => '2008', :action_month=>'2', :action_day=>'5', :from=>'-1', :to=>accounts(:bank1).id.to_s, :adjustment_amount=>'3000', :entry_type => 'adjustment', :year => 2008, :month => 2 }.not_to change { Item.count }
          }
        end
