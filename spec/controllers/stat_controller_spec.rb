...
describe StatController do
  ...
  describe "show_yearly_pl_graph" do
    context "before login" do
      before do
    ...
    context "after login" do
      ...
      context "with account_id" do
        ...
        subject {response}
        it {should render_template "show_yearly_pl_graph"}
      end
      ...
      context "type is income_total" do
        before do
      ...
      context "type is outgo_total" do
        before do
  ...
  describe "yearly_pl_graph" do
    ...
    context "after login" do 
      ...
      context "with invalid id" do
        before do
          get :yearly_pl_graph, :year => 2008, :month => 2, :account_id => '1000000'
        end
