...
== Requirement
* Ruby:
  * MRI (tested continuously with 1.9.2-p290, 1.9.3-p194)
...
* There are some RESTful rule violations in some controllers.(ex. MainController)
...
== The libraries which this product includes
